<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wf_atencialalcliente.aspx.cs" Inherits="WorkFlow_Seguros_Futuro.Formularios.wf_atencialalcliente" %>
        ...
        <div>
            <ext:Viewport ID="Viewport" runat="server" Layout="BorderLayout">
                <Items>
                    ...
                    <ext:GridPanel ID="GridPanel1" runat="server" Collapsible="true" Region="West"
