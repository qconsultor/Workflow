...
{
    public partial class wf_atencialalcliente : System.Web.UI.Page
    {
        ...
        protected void Actualizar_ClickPendiente(string cod_area)
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["SIA_ConnectionString"].ConnectionString;
            string str = "select rtrim(correlativo) as correlativo,* from wf_seguimiento_95 where cod_area=@cod_area and en_re_at IS NULL order by cast(correlativo as int) asc";
