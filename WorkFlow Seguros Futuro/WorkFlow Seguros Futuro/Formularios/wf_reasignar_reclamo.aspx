<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wf_reasignar_reclamo.aspx.cs" Inherits="WorkFlow_Seguros_Futuro.wf_reasignar_reclamo" %>
...
<body>
   ...
   <%-- <ext:Panel runat="server" ID="PanelPrincipal" Title="Reclamos"  Layout="TableLayout" TitleAlign="Center" Theme="Neptune" Icon="Vcard" Height="115" Region="North">
                    <Items>--%>
                 <ext:GridPanel runat="server" ID="GridPanel1" Icon="Tab"  Layout="FitLayout" Title="REASIGNAR TAREAS">
                    <Store>
                    ...
                    <ColumnModel ID="ColumnModel2" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column1" runat="server" DataIndex="Asignado" Text="Asignado" Width="150px">
                                 <Filter>
                                    <ext:StringFilter />
                                </Filter>
                            </ext:Column>
