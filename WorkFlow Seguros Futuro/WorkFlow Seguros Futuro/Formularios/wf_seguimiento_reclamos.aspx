<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wf_seguimiento_reclamos.aspx.cs" Inherits="WorkFlow_Seguros_Futuro.Formularios.wf_seguimiento_reclamos" %>
...
<body>
   ...
   <%-- <ext:Panel runat="server" ID="PanelPrincipal" Title="Reclamos"  Layout="TableLayout" TitleAlign="Center" Theme="Neptune" Icon="Vcard" Height="115" Region="North">
                 ...
                 <ext:GridPanel runat="server" ID="GridPanel1" Icon="Tab"  Layout="FitLayout" Title="SEGUIMIENTO EMISION">
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <ext:Button ID="Button2" runat="server" Text="<b>Asignar ...</b>" Icon="FolderPage">
                                    <DirectEvents>
                                        <Click OnEvent="RealizarConsulta_Click">
                                        </Click>
                                    </DirectEvents>
                                </ext:Button>   
                            </Items>
                 ...
                 <ext:Window runat="server" ID="WindowModificacion" Title="Modificacion" Width="600" Height="150" BodyPadding="10" Resizable="true"
