...
{
    public partial class emision : System.Web.UI.Page
    {
        ...
        private void Grid(object sender, DirectEventArgs e)
        {
            ...
            //sql_quejas_det += " Where  area ='EMISION' and asignado=@asignado and 1=1  ";
        ...
        protected void RealizarConsulta_Click(object sender, DirectEventArgs e)
        {
            ...
            string correlativo, area, tipo_wf, f_docompleta, f_emision, f_e_firmas, f_ate_cliente,estado_tiempo;
        ...
        protected void Cargar_Combo_pasos()
        {
            string strcon = System.Configuration.ConfigurationManager.ConnectionStrings["SIA_ConnectionString"].ConnectionString;
            string sql = "";
            sql += " select paso from ejecucion where inicio is null and correlativo=@correlativo ";
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            SqlConnection con = new SqlConnection(strcon);
            con.Open();
        ...
        protected void Cargar_Combo_pasosFin()
        {
            string strcon = System.Configuration.ConfigurationManager.ConnectionStrings["SIA_ConnectionString"].ConnectionString;
            string sql = "";
            sql += " select paso from ejecucion where fin is null and correlativo=@correlativo ";
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            SqlConnection con = new SqlConnection(strcon);
            con.Open();
        ...
        protected void Actualizar_Inicio(object sender, DirectEventArgs e)
        {
            ...
            string strCon = System.Configuration.ConfigurationManager.ConnectionStrings["SIA_ConnectionString"].ConnectionString;
            string sql = "";
            sql += " update ejecucion set inicio=getdate() where paso=@req_nombre and correlativo=@correlativo ";
            //sql += " update ejecucion set entrega=getdate() where correlativo=@correlativo  ";
