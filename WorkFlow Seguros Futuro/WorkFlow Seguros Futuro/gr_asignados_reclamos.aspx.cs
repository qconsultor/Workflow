...
{
    public partial class gr_asignados_reclamos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sql_chart += " where cod_area in ('02','03') and asignado is not null group by asignado,us.nombre ";
        ...
        private void Grid(object sender, EventArgs e)
        {
            ...
            sql_quejas_det += "  where wf.cod_area in ('02','03') and asignado is not null  ";
