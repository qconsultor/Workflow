            ...
            <table border="1" dir="ltr" style="height: 504px; width: 1414px; margin-right: 0px">
                <tr>
                    <td class="auto-style27">
                        <asp:Panel ID="panelRegistrar" runat="server" BackColor="#2dc234" Width="1594px" Height="509px">
...
<asp:Panel ID="panel2" runat="server" BackColor="#2dc234" Height="229px" Width="568px">
                                                    <%--<div>--%>
                                                    <%--<iframe id="myPDF" runat="server" frameborder="0" name="myPDF" src="previa.html" transparency="transparency"></iframe>--%>
                                                    <%--</div>--%>

                                                    <asp:GridView ID="gridListado" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigo" ForeColor="#333333" GridLines="None" Height="16px" OnPageIndexChanging="gridListado_PageIndexChanging" OnRowDeleting="gridListado_RowDeleting" OnSelectedIndexChanged="gridListado_SelectedIndexChanged1" PageSize="5" Width="550px">
