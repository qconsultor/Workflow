<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wf_entrega_p_AC.aspx.cs" Inherits="WorkFlow_Seguros_Futuro.wf_entrega_p_AC" %>
        ...
        <ext:FieldContainer ID="FieldContainer1" runat="server" Layout="HBoxLayout">
                        ...
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            ...
                            <DirectEvents>
                               <%-- <Click OnEvent="ButtonAceptar_Click" />--%>
                                ...
                                <ext:Button ID="Button2" runat="server" Text="<b>Enviar...</b>" Icon="FolderPage">
                                    <DirectEvents>
            ...
            <Items>
                <ext:FormPanel ID="FormPanel2" runat="server" Border="false" Frame="true" BodyStyle="background-color: transparent" AutoScroll="true" Layout="FormLayout">
                    ...
                    <Buttons>
                        <ext:Button ID="Button1" runat="server" Text="Enviar Atencion al Cliente" Icon="ControlAdd">
                            <DirectEvents>
