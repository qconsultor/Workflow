...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Viewport runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel runat="server" Title="Recepcion" Region="West" Frame="true" Height="350" Layout="FormLayout" Collapsible="true">
                    ...
                    <Items>
                        <ext:Panel runat="server" Flex="1" Layout="FormLayout" DefaultAnchor="75%" Border="false">
                            <Items>
                                <ext:TextField ID="TextFieldContador" runat="server" FieldLabel="No. Solicitud" ReadOnly="true" />
                                ...
                                <ext:ComboBox runat="server" ID="ComboArea" FieldLabel="Area" DataIndex="area" Width="300px">
                                    <Items>
                                ...
                                <ext:TextField runat="server" ID="TextFieldPlan_" Width="300px" FieldLabel="Plan de seguro:" DataIndex="plan_" />
                        ...
                        <ext:Panel runat="server" Flex="1" Layout="FormLayout" DefaultAnchor="98%" Border="false">
                            <Items>
                                ...
                                <%--<ext:ComboBox runat="server" ID="ComboBox2" FieldLabel="Tipo de pollo" DataIndex="tsolicitud" Width="300px">
                                    <Items>
                                        <ext:ListItem Value="INDIO" Text="INDIO" />
                                        <ext:ListItem Value="GRANJA" Text="GRANJA" />
                                    </Items>
                                </ext:ComboBox>--%>
                ...
                <ext:GridPanel runat="server" ID="GridPanel1" Icon="Tab" Title="Vista de solicitudes" Frame="true" Layout="FormLayout" Region="Center" BodyPadding="5" Width="500">
                    <Store>
                ...
                <ext:Panel ID="Panel2" IDMode="Static" runat="server" Title="Archivos" Region="South" Frame="true" Height="380" Layout="FormLayout" Collapsible="false">
                     <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                
                                <ext:Button runat="server" Text="Open window" ID="btnOpen1"><Listeners><Click Handler="newWindow({title: 'Window', height: 350, width: 760, minHeight: 380, minWidth: 760, modal: true}, '', 'window2');" /></Listeners></ext:Button>
                                <ext:Panel ID="Panel1" runat="server" Height="350" Width="300" IDMode="Static"> <Loader ID="Loader3"  runat="server"  Url="../files/318i TwinPower Turbo Luxury (1).pdf" Mode="Frame"> </Loader> </ext:Panel>
        ...
        <ext:Window runat="server" ID="WindowVisualizador" Title="Visualizador" Width="850" Height="700" Icon="ReportDisk" Hidden="true" Modal="true" Draggable="true">
