...
{
    public partial class wf_seguimiento_emision : System.Web.UI.Page
    {
        ...
        private void Grid(object sender, DirectEventArgs e)
        {
            ...
            //sql_quejas_det += " Where  area ='EMISION' and asignado is null and 1=1 and f_desti is not null";
            ...
            sql_quejas_det += " Where  area ='EMISION' and asignado is null and 1=1";
        ...
        protected void Cargar_Combo_pasos()
        {
            string strcon = System.Configuration.ConfigurationManager.ConnectionStrings["SIA_ConnectionString"].ConnectionString;
            string sql = "";
            sql += " select RTRIM(usuario) usuario,RTRIM(nombre) nombre from Usuarios where area='Area Tecnica' ";
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            SqlConnection con = new SqlConnection(strcon);
            con.Open();
